...
export default function LoginPage() {
  ...
  const handleSubmitPhrase = () => {
    if (!validatePhrase(enteredWords)) {
      setError("Invalid phrase. Check each word is spelled correctly.")
      return
    }
      ...
      <div className="w-full max-w-lg">
        {step === "phrase" && (
          <div className="glass-card p-6 sm:p-8">
            <div className="text-center mb-6">
              ...
              <h1 className="text-2xl font-heading font-bold text-white mb-2">Login</h1>
              <p className="text-gray-400 text-sm">Enter your 12-word phrase to access your wallet</p>
            </div>
        ...
        {step === "pin" && (
          <div className="glass-card p-8 text-center">
            <h2 className="text-xl font-heading font-bold text-white mb-2">Set PIN</h2>
            <p className="text-gray-400 text-sm mb-8">
              {!confirmPin ? "Enter your 6-digit PIN" : "Enter the same PIN again to confirm"}
            </p>
